...
## Installation
 ...
 ```sh
 $ git clone https://github.com/nakednous/visual_computing.git
 $ cd visual_computing
...
3. Install dependencies (you must be already on the presentation folder, otherwise ```$ cd visual_computing```)
