...
> Software papers are the only sure way for authors to gain career credit <!-- .element: class="fragment" data-fragment-index="1"-->

Claerbout's doctrine:
> Computational scientists should engage in "really reproducible" research <!-- .element: class="fragment" data-fragment-index="2"-->
...
* Processing Shader API <!-- .element: class="fragment" data-fragment-index="1"-->
* Proscene <!-- .element: class="fragment" data-fragment-index="2"-->

Target audience: that of Processing <!-- .element: class="fragment" data-fragment-index="3"-->
> API simplicity vs API flexibility <!-- .element: class="fragment" data-fragment-index="4"-->
